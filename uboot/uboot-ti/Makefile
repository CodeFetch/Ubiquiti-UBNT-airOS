...
ubnt-wasp_config			: 	unconfig
	@ >include/config.h
ifeq ($(USE_RSA),1)
	@echo '#define USE_RSA 1' >>include/config.h
endif
ifeq ($(UBNT_APP),1)
	@echo "#define UBNT_APP 1" >>include/config.h
endif
ifeq ($(ETH_CONFIG2), _ar8035) #KEBA
# Force dual phy for now on WASP
	@echo '#define CONFIG_AR7242_8035_PHY 1' >>include/config.h
	@echo '#define CFG_DUAL_PHY_SUPPORT 1' >>include/config.h
else #KEBA
ifeq ($(ETH_CONFIG2), _s17)
	@echo '#define CONFIG_ATHRS17_PHY 1' >>include/config.h
...
ifeq ($(DB12X_P2P_ENV), 1)
	...
	@./mkconfig -a ubnt-wasp mips mips ubnt-wasp ar7240 ar7240

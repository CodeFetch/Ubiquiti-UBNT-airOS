...
void wasp_gpio_config(void)
{
	...
	/* enable Ethernet Port 3 Link Status function on GPIO_15 */
	ar7240_reg_rmw_clear(GPIO_OE_ADDRESS, (1 << 15));
	ar7240_reg_rmw_clear(GPIO_OUT_FUNCTION3_ADDRESS, GPIO_OUT_FUNCTION3_ENABLE_GPIO_15_MASK);
	ar7240_reg_rmw_set(GPIO_OUT_FUNCTION3_ADDRESS, GPIO_OUT_FUNCTION3_ENABLE_GPIO_15_SET(0x2c));

	/*enable GPIO function for pins 15-22*/
	ar7240_reg_wr(GPIO_OUT_FUNCTION4_ADDRESS,0);
	ar7240_reg_wr(GPIO_OUT_FUNCTION5_ADDRESS,0);
}
...
#define SHOW_BOOT_PROGRESS show_boot_progress

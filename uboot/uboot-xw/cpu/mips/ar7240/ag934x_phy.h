...
static inline void ag7240_phy_setup(int unit)
{
    ...
    if ((is_ar7242() || is_wasp()) && (unit==0) && athr8236_phy_probe(unit)) {
        athr8236_phy_setup(unit);
    } else
#endif
#ifdef CONFIG_ATHR8032_PHY
    if ((is_ar7242() || is_wasp()) && (unit==0) && athr8032_phy_probe(unit)) {
...
#ifdef CONFIG_ATHR8236_PHY
      if ((is_ar7242() || is_wasp()) && (unit==0) && athr8236_phy_probe(unit)) {
            *duplex = athr8236_phy_is_fdx(unit);
        }
     else
#endif
#ifdef CONFIG_ATHR8032_PHY

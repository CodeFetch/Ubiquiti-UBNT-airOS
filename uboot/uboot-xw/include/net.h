...
typedef enum { BOOTP, RARP, ARP, TFTP, TFTP_SERVER, DHCP, PING, DNS, NFS, CDP, NETCONS, SNTP, ATHRHDR } proto_t;
#else
typedef enum { BOOTP, RARP, ARP, TFTP, TFTP_SERVER, DHCP, PING, DNS, NFS, CDP, NETCONS, SNTP } proto_t;
#endif

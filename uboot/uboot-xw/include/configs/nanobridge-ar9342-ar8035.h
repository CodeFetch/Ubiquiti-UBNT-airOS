...
#ifdef UBNT_TURBO_CLK
#define CFG_PLL_FREQ    CFG_PLL_535_450_178
#elif defined UBNT_TURBO2_CLK
#define CFG_PLL_FREQ    CFG_PLL_560_450_225
#else
#define CFG_PLL_FREQ    CFG_PLL_535_400_200
#endif

#ifdef WASP_USE_FAST_CLK
#define AR9344_FAMILY 0x2120

#define CPU_DPLL_40_AR9350              CPU_DPLL_REFDIV_SET(0x8) | CPU_DPLL_NINT_SET(112)
#define CPU_DPLL_25_AR9350              CPU_DPLL_REFDIV_SET(0x5) | CPU_DPLL_NINT_SET(112)
#define __CPU_DPLL2_VAL_AR9350          CPU_DPLL2_RANGE_SET(1) | \
                                        CPU_DPLL2_KI_SET(0x4) | \
                                        CPU_DPLL2_KD_SET(0x10) | \
                                        CPU_DPLL2_OUTDIV_SET(0) | \
                                        CPU_DPLL2_DELTA_SET(0x1e)

#define DDR_DPLL_40_AR9350              DDR_DPLL_REFDIV_SET(0x8) | DDR_DPLL_NINT_SET(90)
#define DDR_DPLL_25_AR9350              DDR_DPLL_REFDIV_SET(0x5) | DDR_DPLL_NINT_SET(90)

#define __DDR_DPLL2_VAL_AR9350          DDR_DPLL2_RANGE_SET(1) | \
                                        DDR_DPLL2_KI_SET(0x4) | \
                                        DDR_DPLL2_KD_SET(0x10) | \
                                        DDR_DPLL2_OUTDIV_SET(0) | \
                                        DDR_DPLL2_DELTA_SET(0x1e)

#define CPU_DPLL2_INIT_AR9350           __CPU_DPLL2_VAL_AR9350 | CPU_DPLL2_PLL_PWD_SET(1)
#define CPU_DPLL2_VAL_AR9350            __CPU_DPLL2_VAL_AR9350 | CPU_DPLL2_LOCAL_PLL_SET(1)
#define CPU_DPLL2_VAL_PWD_AR9350        CPU_DPLL2_VAL_AR9350 | CPU_DPLL2_PLL_PWD_SET(1)
#define DDR_DPLL2_INIT_AR9350           __DDR_DPLL2_VAL_AR9350 | DDR_DPLL2_PLL_PWD_SET(1)
#define DDR_DPLL2_VAL_AR9350            __DDR_DPLL2_VAL_AR9350 | DDR_DPLL2_LOCAL_PLL_SET(1)
#define DDR_DPLL2_VAL_PWD_AR9350        DDR_DPLL2_VAL_AR9350 | DDR_DPLL2_PLL_PWD_SET(1)
#endif
...
#elif (CFG_PLL_FREQ == CFG_PLL_535_400_200) || (CFG_PLL_535_450_178)
 ...
 * Cache Configuration
 */
#define CONFIG_COMMANDS	(( CONFIG_CMD_DFL | CFG_CMD_PCI | CFG_CMD_FLS |\
	CFG_CMD_MII | CFG_CMD_PING | CFG_CMD_NET | CFG_CMD_JFFS2 | CFG_CMD_ENV | CFG_CMD_PLL| \
	CFG_CMD_FLASH | CFG_CMD_RUN | CFG_CMD_DDR | CFG_CMD_ETHREG | CFG_CMD_TFTP_SERVER ))



#define CFG_PHY_ADDR              5
#define CFG_GMII                  0
...
#define RECOVERY_FWVERSION_ARCH "ar934"
#define AUTO_RESTORE_DEFAULT_ENVIRONMENT 1

/*Check firmware compatibility between old/new Wasp*/
#define FW_COMP_CHECK 

#ifndef _ATHR8021_PHY_H
#define _ATHR8021_PHY_H
...
int athr8021_phy_is_up(int macUnit);
int athr8021_phy_is_fdx(int macUnit);
int athr8021_phy_speed(int macUnit);
u32 athr8021_phy_get_xmii_config(int macUnit, u32 speed);
BOOL athr8021_probe(int macUnit);
BOOL athr8021_phy_setup(int macUnit);

#endif /* _ATHR8021_PHY_H */

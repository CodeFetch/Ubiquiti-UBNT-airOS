...
static void __init ar71xx_detect_mem_size(void)
{
	...
	/* Move ebase one page to front, and reserve 1 page at 0 address for TX DS errors */
	write_c0_ebase(0x80001000);
	add_memory_region(0, 4096, BOOT_MEM_RESERVED);
	memset((void *)0x80000000, 0, 4096);
	add_memory_region(4096, size-4096, BOOT_MEM_RAM);
}
